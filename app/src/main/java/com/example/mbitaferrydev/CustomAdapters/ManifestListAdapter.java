package com.example.mbitaferrydev.CustomAdapters;
...
import com.example.mbitaferrydev.Models.Manifests;
import com.example.mbitaferrydev.R;
...
public class ManifestListAdapter extends ArrayAdapter<Manifests> {
    ...
    public ManifestListAdapter(Context context, int textViewResourceId) {
